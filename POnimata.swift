protocol POnimata {
	...
	func distributionCarte (jBleu : TJoueur, jRouge: TJoueur)
	...
	func echangeCarte (newRes : TCarte, newMain : TCarte, joueur : TJoueur)
	...
	func affichePlateauAvecPiece (joueurBleu : jB, joueurRouge : jR) -> String
